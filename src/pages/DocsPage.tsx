  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
            <h2 className="text-2xl font-semibold border-b pb-2">Раздел 3: Управление проектами</h2>
            <h3 className="text-xl font-semibold pt-2">Создание проекта</h3>
            <p>
                На главной странице нажмите кнопку "Создать проект". Первый созданный проект будет демонстрационным проектом "Разработка Mutabor" с примерами задач для быстрого старта. Все последующие проекты будут создаваться пустыми.
            </p>
            <h3 className="text-xl font-semibold pt-2">Удаление проекта</h3>
            <p>
                Чтобы удалить проект, найдите его карточку на главной странице и нажмите кнопку "Удалить проект" внизу. Появится диалоговое окно для подтверждения. <strong>Внимание:</strong> удаление проекта также приведет к удалению всех задач внутри него. Это действие необратимо.
            </p>
        </div>

        <div className="space-y-4">
            <h2 className="text-2xl font-semibold border-b pb-2">Раздел 4: Ключи задач</h2>
            <p>
        ...
        <div className="space-y-4">
            <h2 className="text-2xl font-semibold border-b pb-2">Раздел 5: Дальнейшие шаги</h2>
